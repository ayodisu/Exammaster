...
export default function DashboardLayout({ children, menuItems, roleLabel }: DashboardLayoutProps) {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex overflow-x-hidden">
            ...
            {/* Main Content Area */}
            <div className={`flex-1 flex flex-col min-h-screen min-w-0 transition-all duration-300 ${collapsed ? 'md:ml-20' : 'md:ml-64'}`}>
                <Header
                    roleLabel={roleLabel}
                ...
                <main className="flex-1 p-6 mt-20 md:p-8 max-w-7xl mx-auto w-full overflow-x-hidden animate-in fade-in duration-500">
                    {children}
                </main>
